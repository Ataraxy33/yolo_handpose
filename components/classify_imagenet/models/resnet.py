...
def EfficientNetb5(**kwargs):
    ...
    # if pretrained:
    #     pretrained_state_dict = torch.load_state_dict(model_path)
    #     model = EfficientNetb5.from_name('efficientnet-b5')
...
if __name__ == "__main__":
    ...
    # model = EfficientNetb5(num_classes=2, img_size=256)
    # output = model(input)
    # print(output.size())
