...
from components.hand_detect.yolov3 import Yolov3, Yolov3Tiny
from components.hand_detect.utils.torch_utils import select_device
from components.hand_detect.acc_model import acc_model
